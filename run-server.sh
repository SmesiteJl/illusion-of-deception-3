...
./gradlew :services:product-service:product-impl:bootJar --no-daemon
./gradlew :services:order-service:order-impl:bootJar --no-daemon
./gradlew :services:cart-service:cart-impl:bootJar --no-daemon
